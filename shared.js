...
export function showNotes(movie) {
  ...
  // style the title
  title.className =
    "text-3xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600";
  ...
  addNoteInput.className =
    "w-full bg-gray-700 text-white px-4 py-2 rounded-lg mb-2";
  addNoteBtn.className =
    "w-full bg-gradient-to-r from-purple-500 to-pink-500 text-white font-bold py-2 px-4 rounded-lg hover:from-purple-600 hover:to-pink-600 transition duration-300";
  ...
  closeModalTop.className =
    "absolute top-2 right-2 text-gray-500 hover:text-white transition duration-300";
  closeModalBottom.className =
    "mt-4 bg-gray-500 text-white font-bold py-2 px-4 rounded-lg hover:bg-gray-600 transition duration-300";
...
export function createNote(note, movie) {
  ...
  noteEntry.className =
    "bg-gray-700 rounded-lg p-3 flex justify-between items-center";
  ...
  removeNoteBtn.className =
    "text-red-500 hover:text-red-700 transition duration-300";
...
export const createMovieCard = (movie, isDiary = false) => {
  ...
  if (isInJournal(movie)) {
    if (isDiary) {
      const showNotesBtn = createButton("Notes", "fa-note-sticky", () =>
        showNotes(movie)
      );
